...
function Binding(container, key, force) {
  ...
  _this.file = function(filename, bindOptions) {
    ...
    var bindOptions = _private.initBindOptions(bindOptions);
    var key = _container.resolveWildcard(_key, filename, bindOptions);
  ...
  _private.initBindOptions = function(bindOptions) {
    ...
    return _.extend(_.clone(DEFAULT_BIND_OPTIONS), bindOptions || {});
  }
}
